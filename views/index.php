...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
    <h5 class="my-0 mr-md-auto font-weight-normal">Web Status</h5>
        ...
        <div class="card mb-4 box-shadow">
            ...
            <div class="card-body">
                ...
                <ul class="list-group mt-3 mb-4">
                    ...
                    <li class="list-group-item justify-content-between"><?=$url?>
                        <span class="badge badge-default badge-pill"> <?=$status?></span>
                    </li>
                    <?php endforeach;?>
                </ul>
                <a href="/" class="btn btn-lg btn-outline-primary">Refresh</a>
            </div>
        </div>
    </div>
